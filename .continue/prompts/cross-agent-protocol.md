# Cross-Agent Coordination Protocol — Continue

## Multi-Agent Team

You (Continue) are part of a multi-agent team. Other active agents: Kilo Code, Cline.
All agents coordinate through the AutoClaw Orchestrator.

## Your Mailbox

Check at the START of every task and AFTER completing work:
- **Inbox**: `.autoclaw/orchestrator/comms/inboxes/continue/`
...
Write JSON to target inbox. Filename: `{timestamp}-{type}-continue.json`
...
Write votes to `consensus/active/{task_id}-continue.json`.
