  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-100 dark:from-black dark:via-zinc-900 dark:to-black text-foreground">
      ...
      <main className="flex-grow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto relative z-10">
            ...
            <div className="animate-fade-in-up space-y-6">
              <div className="space-y-4">
                <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-black via-gray-800 to-black dark:from-white dark:via-gray-200 dark:to-white bg-clip-text text-transparent leading-tight">
                  Ayuk Giress
                </h1>
        ...
        {/* About Section */}
        <section id="about" className="min-h-screen flex items-center justify-center px-5 py-20 bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-900/50 dark:to-black relative">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            <div className="space-y-8">
              ...
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed animate-fade-in-delay">
                I'm a passionate full-stack developer with a love for creating innovative web applications.
                I specialize in modern web technologies and enjoy bringing ideas to life through clean, efficient code.
                When I'm not coding, you'll find me exploring new technologies or contributing to open-source projects.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/10 transform transition-all duration-500 hover:-translate-y-2 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-black dark:text-white">Frontend</h3>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">React, Next.js, TypeScript, Tailwind CSS</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/10 transform transition-all duration-500 hover:-translate-y-2 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-black dark:text-white">Backend</h3>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">Node.js, Express, Python, PostgreSQL</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/10 transform transition-all duration-500 hover:-translate-y-2 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">Git, Docker, AWS, VS Code</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Projects Section */}
        <section id="projects" className="min-h-screen flex items-center justify-center px-5 py-20 bg-gradient-to-b from-white to-gray-50/50 dark:from-black dark:to-gray-900/50 relative">
        ...
        {/* Contact Section */}
        <section id="contact" className="min-h-screen flex items-center justify-center px-5 py-20 bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-900/50 dark:to-black relative">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            <div className="space-y-8 mb-16">
              ...
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed animate-fade-in-delay">
                ...
                or just have a chat about technology. Let's connect and build something amazing together!
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <div className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-2 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  ...
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-black dark:text-white">Email</h3>
                    <p className="text-gray-600 dark:text-gray-300">ayuk.giress@example.com</p>
                  </div>
                  <a href="mailto:ayuk.giress@example.com" className="inline-flex items-center gap-2 text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-semibold transition-colors group/link">
              ...
              <div className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-2 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Somewhere in the World</p>
                  </div>
            ...
            <div className="space-y-8">
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  ...
                  className="group bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-4 rounded-2xl text-lg font-semibold hover:from-green-700 hover:to-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-green-500/25 transform hover:-translate-y-1 flex items-center gap-3"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                ...
                <a
                  href="#home"
                  className="group border-2 border-green-600 text-green-600 dark:text-green-400 px-8 py-4 rounded-2xl text-lg font-semibold hover:bg-green-600 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-green-500/25 transform hover:-translate-y-1 flex items-center gap-3"
                >
              ...
              <div className="flex justify-center space-x-6">
                <a href="#" className="group p-3 bg-white/80 dark:bg-gray-800/80 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-200/50 dark:border-gray-700/50">
