  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 text-foreground">
      ...
      <main className="flex-grow">
        ...
        <section
          id="about"
          className="min-h-screen flex items-center justify-center px-5 py-24 bg-black relative"
        >
            ...
            <div className="mt-16 space-y-16 animate-fade-in-down">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                  {/* JavaScript */}
                  <div
                    className="flex flex-col items-center gap-3 group animate-stagger-fade-in"
                    style={{ animationDelay: "0s" }}
                  >
                    <div
                      className="w-16 h-16 bg-yellow-400 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "0s" }}
                    >
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-orange-500 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "1s" }}
                    >
                      <SiHtml5 className="w-8 h-8 text-white" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.html5")}
                    </span>
                  </div>
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-cyan-500 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-black rounded-xl flex items-center justify-center shadow-lg border border-gray-700 tech-icon animate-float"
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-teal-500 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 justify-center">
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-green-600 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "3s" }}
                    >
                      <SiNodedotjs className="w-8 h-8 text-white" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.nodejs")}
                    </span>
                  </div>
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-gray-600 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "3.5s" }}
                    >
                      <SiExpress className="w-8 h-8 text-white" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.express")}
                    </span>
                  </div>
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-red-600 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "4s" }}
                    >
                      <SiNestjs className="w-8 h-8 text-white" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.nestjs")}
                    </span>
                  </div>
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-cyan-600 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "4.5s" }}
                    >
                      <SiReactquery className="w-8 h-8 text-white" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.reactnative")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 gap-6 justify-center">
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-green-500 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "5s" }}
                    >
                      <SiMongodb className="w-8 h-8 text-white" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.mongodb")}
                    </span>
                  </div>
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-blue-800 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "5.5s" }}
                    >
                      <SiPostgresql className="w-8 h-8 text-white" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.postgresql")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6 justify-center">
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-orange-600 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "6s" }}
                    >
                      <SiGit className="w-8 h-8 text-white" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.git")}
                    </span>
                  </div>
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-red-500 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "6.5s" }}
                    >
                      <SiNpm className="w-8 h-8 text-white" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.npm")}
                    </span>
                  </div>
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-yellow-500 rounded-xl flex items-center justify-center shadow-lg tech-icon animate-float"
                      style={{ animationDelay: "7s" }}
                    >
                      <SiPnpm className="w-8 h-8 text-black" />
                    </div>
                    <span className="text-white font-medium bg-black/50 px-3 py-1 rounded">
                      {t("about.technologies.pnpm")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-white/10 dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-3 border border-gray-200/20 dark:border-gray-700/50">
                <div className="space-y-6">
                  <div className="w-full h-48 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-lg overflow-hidden">
                    <img
                      src="/certificates/Screenshot from 2025-11-17 10-42-33.png"
                  ...
                  <div className="space-y-3">
                    <h3 className="text-2xl font-bold text-white">
                      {t("certifications.javascript.title")}
                    </h3>
                    <p className="text-gray-300 leading-relaxed">
                      {t("certifications.javascript.description")}
                    </p>
                  </div>
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-yellow-100/20 text-yellow-300 rounded-full text-sm font-medium border border-yellow-400/30">
                        {t("certifications.javascript.level")}
                      </span>
                      <span className="px-3 py-1 bg-gray-100/20 text-gray-300 rounded-full text-sm font-medium border border-gray-400/30">
                        {t("certifications.javascript.platform")}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="group bg-white/10 dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-3 border border-gray-200/20 dark:border-gray-700/50">
                <div className="space-y-6">
                  <div className="w-full h-48 bg-gradient-to-br from-cyan-400 to-cyan-600 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-lg overflow-hidden">
                    <img
                      src="/certificates/Screenshot from 2025-11-17 10-42-51.png"
                  ...
                  <div className="space-y-3">
                    <h3 className="text-2xl font-bold text-white">
                      {t("certifications.react.title")}
                    </h3>
                    <p className="text-gray-300 leading-relaxed">
                      {t("certifications.react.description")}
                    </p>
                  </div>
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-cyan-100/20 text-cyan-300 rounded-full text-sm font-medium border border-cyan-400/30">
                        {t("certifications.react.level")}
                      </span>
                      <span className="px-3 py-1 bg-gray-100/20 text-gray-300 rounded-full text-sm font-medium border border-gray-400/30">
                        {t("certifications.react.platform")}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="group bg-white/10 dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-3 border border-gray-200/20 dark:border-gray-700/50">
                <div className="space-y-6">
                  <div className="w-full h-48 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-lg overflow-hidden">
                    <img
                      src="/certificates/Screenshot from 2025-11-17 10-43-25.png"
                  ...
                  <div className="space-y-3">
                    <h3 className="text-2xl font-bold text-white">
                      {t("certifications.nodejs.title")}
                    </h3>
                    <p className="text-gray-300 leading-relaxed">
                      {t("certifications.nodejs.description")}
                    </p>
                  </div>
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-green-100/20 text-green-300 rounded-full text-sm font-medium border border-green-400/30">
                        {t("certifications.nodejs.level")}
                      </span>
                      <span className="px-3 py-1 bg-gray-100/20 text-gray-300 rounded-full text-sm font-medium border border-gray-400/30">
                        {t("certifications.nodejs.platform")}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.0.tech1")}
                      </span>
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.0.tech2")}
                      </span>
                    </div>
                    <a
                      href="#"
              ...
              <div className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-3 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  <div className="w-full h-48 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-lg overflow-hidden">
                    <img
                      src="/project-images/Screenshot from 2025-11-16 14-06-26.png"
                  ...
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.1.tech1")}
                      </span>
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.1.tech2")}
                      </span>
                    </div>
                    <a
                      href="#"
              ...
              <div className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-3 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  <div className="w-full h-48 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-lg overflow-hidden">
                    <img
                      src="/project-images/Screenshot from 2025-11-16 14-10-03.png"
                  ...
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.2.tech1")}
                      </span>
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.2.tech2")}
                      </span>
                    </div>
                    <a
                      href="#"
              ...
              <div className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-3 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  <div className="w-full h-48 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-lg overflow-hidden">
                    <img
                      src="/project-images/Screenshot from 2025-11-16 14-15-43.png"
                  ...
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.3.tech1")}
                      </span>
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.3.tech2")}
                      </span>
                    </div>
                    <a
                      href="#"
              ...
              <div className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-3 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  <div className="w-full h-48 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-lg overflow-hidden">
                    <img
                      src="/project-images/Screenshot from 2025-11-16 14-18-07.png"
                  ...
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.4.tech1")}
                      </span>
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.4.tech2")}
                      </span>
                    </div>
                    <a
                      href="#"
              ...
              <div className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:shadow-green-500/20 transform transition-all duration-500 hover:-translate-y-3 border border-gray-200/50 dark:border-gray-700/50">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.5.tech1")}
                      </span>
                      <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium">
                        {t("projects.items.5.tech2")}
                      </span>
                    </div>
                    <a
                      href="#"
        ...
        <section
          id="contact"
          className="min-h-screen flex items-center justify-center px-5 py-24 bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-900/50 dark:to-black relative overflow-hidden"
        >
          ...
          <div className="max-w-6xl mx-auto w-full relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-stretch mb-16">
