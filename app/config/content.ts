...
export const heroContent: HeroContent = {
  ...
  description: 'Passionate about creating amazing web experiences with modern technologies and clean, efficient code.',
  primaryCTA: {
    label: 'View My Work',
    href: '#projects'
  },
...
export const aboutContent = {
  title: 'About Me',
  description: 'I\'m a passionate Full Stack Developer with expertise in modern web technologies. I love creating efficient, scalable solutions that provide exceptional user experiences.',
  skills: [
    'React & Next.js',
    'TypeScript',
    'Node.js',
...
export const contactContent: ContactInfo = {
  email: 'ayuk.giress@example.com',
  phone: '+1 (555) 123-4567',
  location: 'San Francisco, CA',
  socialLinks: [
    {
      platform: 'GitHub',
      url: 'https://github.com/ayukgiress',
      icon: ({ className }) => (
    ...
    {
      platform: 'LinkedIn',
      url: 'https://linkedin.com/in/ayukgiress',
      icon: ({ className }) => (
        <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      platform: 'Twitter',
      url: 'https://twitter.com/ayukgiress',
      icon: ({ className }) => (
        <svg className={className} fill="currentColor" viewBox="0 0 24 24">
